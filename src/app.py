...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM; Games on Saturdays",
        "max_participants": 25,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Join the basketball team to train, scrimmage and play interschool games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM; Games on Fridays",
        "max_participants": 20,
    ...
    "Theater Club": {
        "description": "Acting, stagecraft and production; put on plays and showcases",
